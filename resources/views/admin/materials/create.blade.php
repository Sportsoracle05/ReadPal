  ...
  <div class="a-card fu1">
    ...
    <form method="POST"
      ...
      <div class="mb-4">
                ...
                <select name="type" id="type" class="form-input cursor-pointer">
                    <option value="note" class="text-gray-500 dark:bg-gray-900 dark:text-gray-400">Note</option>
            ...
            <div id="noteField" class="mb-4 hidden">
                ...
                <textarea name="note_text" id="note_text" rows="8" class="w-full mt-1 p-2 border rounded-md dark:bg-gray-800 dark:border-gray-700"></textarea>
