<footer class="mt-auto bg-white rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
  <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
      &copy; 2024-{{ now()->year }} <a href="{{ config('app.url') }}" class="hover:underline" target="_blank">{{ config('app.name') }}</a>. All rights reserved.
  </p>
