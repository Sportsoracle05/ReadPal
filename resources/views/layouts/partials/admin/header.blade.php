...
<header class="antialiased">
    ...
    <nav class="px-4 lg:px-6 py-2.5">
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        <div class="hidden lg:flex space-x-8 items-center">
          <a href="{{ route('admin.dashboard') }}" class="text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400">Dashboard</a>
          <a href="{{ route('admin.materials.index') }}" class="text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400">Materials</a>
          <a href="{{ route('admin.resources.index') }}" class="text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400">Resources</a>
          <a href="{{ route('admin.lectures.index') }}" class="text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400">Lectures</a>
        </div>
  ...
  <div class="relative z-40">
        ...
        <div id="mobile-menu" 
         class="hidden w-64 bg-white divide-y divide-gray-100 rounded-lg shadow-lg dark:bg-gray-700 dark:divide-gray-600">
          <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
            <li><a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Dashboard</a></li>
            <li><a href="{{ route('admin.resources.index') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Resources</a></li>
            <li><a href="{{ route('admin.materials.index') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Materials</a></li>
            <li><a href="{{ route('admin.lectures.index') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Lectures</a></li>
          </ul>
        </div>
    ...
    <div id="notification-dropdown"
      ...
      <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
        <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">New comment on your post</a></li>
        <li><a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Server maintenance scheduled</a></li>
      </ul>
    </div>
    ...
    <div id="apps-dropdown"
      ...
      <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
        <li><a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">Dashboard</a></li>
        <li><a href="{{ route('dashboard') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600">User-View</a></li>
