{{--
    resources/views/ai/layout.blade.php  (Hybrid AI — v2)
    Forest Green × Ink SaaS Dashboard aesthetic
    Monospace for data, Sharp borders, Semi-transparent overlays
--}}
@extends('layouts.app')
...
<div class="ai-shell" id="aiShell">
    ...
    <aside class="ai-sidebar" id="aiSidebar">
        ...
        <div class="sidebar-header">
            ...
            <a href="{{ route('ai.chat') }}" class="sidebar-brand">
                <div class="brand-mark">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="color:var(--forest-400);position:relative;z-index:1">
                ...
                <div>
                    <span class="brand-text">ReadPal</span>
                    <span class="brand-badge">AI</span>
                </div>
            </a>
            
            <a href="{{ route('ai.chat') }}" class="new-chat-btn">
        ...
        <div class="sidebar-body">
            {{-- Recent --}}
            <div class="sidebar-section" style="margin-top:6px;">Recent</div>

            @if(isset($recentHistory) && $recentHistory->isNotEmpty())
                @foreach($recentHistory as $conv)
                <button class="sidebar-item" onclick="loadHistory({{ $conv->id }})">
                    <span class="sidebar-icon" style="opacity:0.5;">›</span>
                    <span class="sidebar-label">{{ Str::limit($conv->question, 32) }}</span>
                </button>
                @endforeach
            @else
                <div style="padding:6px 16px; font-size:12px; color:var(--ink-400);">No recent questions.</div>
            @endif

            <a href="{{ route('ai.history') }}" class="sidebar-item" style="margin-top:2px;">
                <span class="sidebar-icon">⊞</span>
                <span class="sidebar-label">Full history</span>
            </a>
        ...
        <div class="sidebar-footer">
            <div class="user-tile">
                ...
                <div class="user-info">
                    ...
                    <div class="user-meta mono">300L · SOC</div>
                </div>
            </div>
        </div>
    ...
    <div class="ai-main">
        ...
        <div class="ai-topbar">
            ...
            <div class="topbar-title">@yield('page-title', 'AI Assistant')</div>
